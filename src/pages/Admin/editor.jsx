   ...
   const onChangeValue = (e) => {
    ...
    const handleSubmit = () => {
      ...
      if(userInfo.title == "") {
         ...
         axios.post("https://placeineat.onrender.com/edit-post", {
           body: dataForm,
         })
         .then(function (response) {
            setTimeout(() => {
...
export const PageSetting = () => {
   ...
   const onUpload = async e => {
      ...
      fetch("https://placeineat.onrender.com/upload_files", {
          method: 'POST',
          body: formData,
      })
   ...
   const handleSubmit = () => {
      ...
      if(file == null) {
         ...
         axios.post("https://placeineat.onrender.com/upload-details", {
           body: data,
         })
         .then(function (response) {
            setTimeout(() => {
...
export const Action = () => {
   ...
   const { data } = useGetPostById(postId) 
   const handleSubmit = () => {
      axios.post("https://placeineat.onrender.com/update-post", {
         body: postId,
       })
       .then(function (response) {
          setTimeout(() => {
