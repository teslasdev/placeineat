...
import { useCreatePreference, useGetPreference } from '../../helpers/api-hooks/usePreference'
import AddModalPrompt from '../../../general/Modal/AddModalPreference'
import AddModalPreference from '../../../general/Modal/AddModalPreference'
...
const Preference = () => {
   ...
   const {data , isLoading} = useGetPreference(0);
   return (
